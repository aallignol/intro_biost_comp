...
<<sac_base_2, size = "scriptsize">>=
s_means <- lapply(s_iris, function(x) colMeans(x[1:4]))
s_means[[1]]
@ %def
\item Combine
<<sac_base3, size = "scriptsize">>=
